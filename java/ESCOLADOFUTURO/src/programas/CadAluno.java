...
public class CadAluno {
	...
	public static void main(String[] args) {
		...
		//tem que fazer o processo até que a pergunta continua sim ou não seja não
		//após mostr todos os alunos com nota pela regra
		//até 5 - estude mais
		...
		System.out.println("MAT\tSTATUS\tNOTA\tNOME");
		 ...
		 for (int x=0; x<alunes.length; x++) {
			...
			//mostrando todos os alunos que tem nota
